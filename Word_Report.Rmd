...
p_temp_mean <- plot_data(processed_data,"monthly","mean","air_temperature","Date") 
p_temp_max <- plot_data(processed_data,"daily","max","air_temperature","Date") 
p_temp_min <-plot_data(processed_data,"daily","min","air_temperature","Date") 

if(!dir.exists("png")) dir.create("png")
ggsave("png/p_temp_mean.png",p_temp_mean)
ggsave("png/p_temp_max.png",p_temp_max)
ggsave("png/p_temp_min.png",p_temp_max)
...
p_hum_mean <- plot_data(processed_data,"monthly","mean","rltv_hum","Date") 
p_hum_max <- plot_data(processed_data,"daily","max","rltv_hum","Date") 
p_hum_min <-plot_data(processed_data,"daily","min","rltv_hum","Date") 

if(!dir.exists("png")) dir.create("png")
ggsave("png/p_hum_mean.png",p_hum_mean)
ggsave("png/p_hum_max.png",p_hum_max)
ggsave("png/p_hum_min.png",p_hum_max)
...
p_wind_mean <- plot_data(processed_data,"monthly","mean","wind_speed","Date") 
p_wind_max <- plot_data(processed_data,"daily","max","wind_speed","Date") 
p_wind_min <-plot_data(processed_data,"daily","min","wind_speed","Date") 

if(!dir.exists("png")) dir.create("png")
ggsave("png/p_wind_mean.png",p_wind_mean)
ggsave("png/p_wind_max.png",p_wind_max)
ggsave("png/p_wind_min.png",p_wind_max)
...
p_visib_mean <- plot_data(processed_data,"monthly","mean","visibility","Date") 
p_visib_max <- plot_data(processed_data,"daily","max","visibility","Date") 
p_visib_min <-plot_data(processed_data,"daily","min","visibility","Date") 

if(!dir.exists("png")) dir.create("png")
ggsave("png/p_visib_mean.png",p_visib_mean)
ggsave("png/p_visib_max.png",p_visib_max)
ggsave("png/p_visib_min.png",p_visib_max)
